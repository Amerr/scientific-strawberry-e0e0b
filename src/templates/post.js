...
import {classNames, withPrefix, Link, getData, htmlToReact} from '../utils';
            	...
            	<div className="container container--medium">
            		<div className="post__meta flex-lg mb-4">
            			{_.get(this.props, 'pageContext.frontmatter.author', null) && ((() => {
            			    let author_data = getData(this.props.pageContext.site.data, _.get(this.props, 'pageContext.frontmatter.author', null));
            			    return (
